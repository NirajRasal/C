...
hxy=(-1)*((px1y1)*(log10(px1y1)/log10(2)))+(px1y2*(log10(px1y2)/log10(2)))+(px2y1*(log10(px2y2)/log10(2)))+(px2y2*(log10(px2y2)/log10(2)));
...
output
 ...
 probabilities of y:py1=0.440000
 py2=0.400000

 entropy of x is : 0.206843 bits per symbol
 entropy of y is: -0.007624 bits per symbol

 joint probabilities are: px1y1=0.120000
 px1y2=0.080000
 px2y1=0.320000
 px2y2=0.480000

joint entropy is:-0.771556 bits per symbol

conditional entropy is:-0.794079 bits per symbol
conditional entropy is:0.022523 bits per symbol
 mutual information is:ix1y1=0.447459bits
 ix1y2=0.000000bits
 ix2y1=-0.137504bits
 ix2y2=0.584963bits

average mututal information is:0.786454bits   */
